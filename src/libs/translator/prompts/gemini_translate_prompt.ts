export const TRANSLATE_PROMPT = `You are a professional translator specializing in video subtitles. Your task is to translate the English subtitles provided in the JSON array below into natural-sounding Korean.
